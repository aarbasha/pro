...
<div class="container-fluid">
    ...
    <div class="col-sm-3">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <p class="card-text">Objectively innovate empowered manufactured products whereas parallel
                    platforms. Holisticly predominate extensible testing procedures for reliable supply chains.
        ...
        <div class="card">
            ...
            <div class="card-block">
                <p class="card-text">Proactively envisioned multimedia based expertise and cross-media growth
                    strategies.</p>
        ...
        <div class="row">
            <article class="col-xs-12">
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item"><a href="#"><span class="glyphicon glyphicon-comment"></span> 21
                            Comments</a></li>
        ...
        <div class="row">
            <article class="col-xs-12">
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item"><a href="#"><span class="glyphicon glyphicon-comment"></span> 12
                            Comments</a></li>
